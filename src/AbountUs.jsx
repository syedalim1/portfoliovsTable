...
const AboutUs = () => {
  return (
    <div
      id="about" // Add the ID for navigation
      className="mx-auto px-6 py-10 bg-gradient-to-r from-indigo-100 via-purple-100 to-pink-100 shadow-xl rounded-lg"
    >
      {/* Logo Section */}
      <div className="flex justify-center mb-8">
        <img
          src="/aboutus.png"
          alt="About Us"
          className="w-40 drop-shadow-lg animate__animated animate__fadeIn animate__delay-1s"
        />
      </div>
